...
const resources = [
  {
    ...
    name: '應用程式整合',
    description:
      '不同的應用程式可以透過 Open API 來實現數據和功能的集成，從而提高整體效能和互操作性。',
    icon: UserIcon,
    pattern: {
      y: 16,
      squares: [
  ...
  },
  {
    ...
    name: '平台擴展',
    description:
      '開發人員可以利用 Open API 來擴展現有平台的功能，將其整合到其他應用程式或服務中。',
    icon: ChatBubbleIcon,
    pattern: {
      y: -6,
      squares: [
  ...
  },
  {
    ...
    name: '第三方開發',
    description:
      'Open API 提供了一個開放的框架，允許第三方開發者創建應用程式或服務，以滿足不同用戶的需求。',
    icon: EnvelopeIcon,
    pattern: {
      y: 32,
      squares: [
